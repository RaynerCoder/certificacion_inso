...
class IngredienteTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Composicion', 'composicion')->sortable(),
            Column::make('Riesgo salud', 'riesgo_salud')->sortable(),
            $this->columnaEstado(),
    ...
    private function columnaAcciones(): Column
    {
        return Column::make('Acciones')
            ->label(fn ($ingrediente) => view('ingredientes.accion', ['ingrediente' => $ingrediente]))
            ->html();
    }
