<x-admin-layout :title="$tituloPagina . ' | Certificador'" :breadcrumbs="[
    ...
    ['name' => $tituloPagina, 'href' => route('seguimientos_tramites_registrados_funcionario')],
]">
    @php
        // Esta pantalla consulta solo los trámites creados por el usuario interno que inició sesión.
        $bandeja = 'registrados';
    @endphp
