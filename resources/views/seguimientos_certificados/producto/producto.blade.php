...
<div class="producto-step" data-producto-step="0">
    <section class="producto-section">
        <div class="producto-step-grid grid grid-cols-1 gap-x-4 gap-y-3 lg:grid-cols-12">
            ...
            <div class="lg:order-9 lg:col-span-6">
            ...
            <div class="lg:order-5 lg:col-span-5">
            ...
            <div class="lg:order-6 lg:col-span-4">
            ...
            <div class="lg:order-7 lg:col-span-6">
            ...
            <div class="lg:order-8 lg:col-span-6">
            ...
            <div class="lg:order-10 lg:col-span-6">
                <div class="mb-2 flex items-center justify-between gap-2">
