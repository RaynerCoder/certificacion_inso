<x-admin-layout title="Certificados | Certificador" :breadcrumbs="[
    ...
    [
        'name' => 'Crear',
        'href' => route('certificados_create'),
    ],
]">
    ...
    <form action="{{ route('certificados_store') }}" method="POST" id="formRegistrarCertificado"
                    ...
                    <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-sm leading-relaxed text-slate-500">
                                Complete los datos del certificado y verifique los requisitos necesarios por el tipo de certificado seleccionado.
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-xs text-gray-500">
                                    Registra el tipo, personas relacionadas, fechas y documento.
                                </p>
                            </div>
                        </div>
                    ...
                    <section class="cert-card">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    Se cargan desde el tipo de certificado seleccionado.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="p-4 sm:p-5">
                            ...
                            <div class="flex flex-col gap-3 p-5 sm:flex-row sm:justify-end sm:p-6">
                                ...
                                <button type="reset" onclick="reiniciarResumenCertificado()"
                                    class="cert-ghost-btn px-4">
                                    {!! $icon('broom', 'cert-svg-sm') !!}
                                    <span>Limpiar formulario</span>
                                </button>
                                
                                    {{-- Permite continuar registrando otro certificado despues del guardado. --}}
                                    <button type="submit" name="accion" value="guardar_otro"
                                        class="cert-ghost-btn px-4">
                                        {!! $icon('plus', 'cert-svg-sm') !!}
                                        <span>Guardar y registrar otro</span>
                                    </button>

                                {{-- Guarda el certificado/tramite principal y sus requisitos. --}}
    ...
    @push('js')
        ...
        <script>
            ...
            // Inicializa limpio al entrar a registrar, pero conserva datos si vuelve por validacion.
            inicializarBuscadoresPersonasCertificado();
            limpiarRegistroNuevoCertificado();
            ...
            if (tieneErroresServidorCertificado && tipoSelect?.value) {
                cargarRequisitosDelTipo();
            } else {
                actualizarResumenCertificado();
            }

            // Si el navegador restaura la pagina desde cache, evita mostrar datos viejos.
