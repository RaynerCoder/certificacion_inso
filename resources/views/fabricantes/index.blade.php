<x-admin-layout title="Control de Productos | Certificador" :breadcrumbs="[
    [
        'name' => 'Menú',
    ...
    <x-slot name="action">
        <x-wire-button href="{{ route('fabricantes_create') }}" blue>
            Nuevo
        </x-wire-button>
    </x-slot>


    <!-- Es la ruta para la tabla de fabricantes en la direccion: app/Livewire/Datatables/FabricanteTable.php -->
